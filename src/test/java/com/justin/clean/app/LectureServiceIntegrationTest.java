...
class LectureServiceIntegrationTest extends IntegrationTest {
    ...
    void shouldThrowExceptionWhenDuplicateRegistration() {
        // given
        var lecture = LectureTestDataBuilder.defaultForJpa();
    ...
    void shouldThrowExceptionWhenLectureIsFull() {
        ...
        var lectureRegister = LectureRegisterTestDataBuilder.defaultWithLectureId(savedLecture.getId());
    ...
    void shouldFindAllRegisteredLecturesByUser() {
        // given
        var givenLectures = LectureTestDataBuilder.defaultMultipleForJpa();
    ...
    void shouldFindAllAvailableLecturesByDate() {
        // given
        List<Lecture> givenLectures = LectureTestDataBuilder.defaultMultipleForJpa();
